...
void ULagCompensationComponent::MoveBoxes(AMyCharacter* HitCharacter, const FFramePackage& Package)
{
	if (HitCharacter == nullptr) return;
	for (auto& HitBoxPair : HitCharacter->HitCollisionBoxes)
	{
...
void ULagCompensationComponent::ResetHitBoxes(AMyCharacter* HitCharacter, const FFramePackage& Package)
{
	if (HitCharacter == nullptr) return;
	for (auto& HitBoxPair : HitCharacter->HitCollisionBoxes)
	{
...
void ULagCompensationComponent::EnableCharacterMeshCollision(AMyCharacter* HitCharacter, ECollisionEnabled::Type CollisionEnabled)
{
...
void ULagCompensationComponent::ServerScoreRequest_Implementation(AMyCharacter* HitCharacter, const FVector_NetQuantize& TraceStart, const FVector_NetQuantize& HitLocation, float HitTime)
{
...
{
	Character = Character == nullptr ? Cast<AMyCharacter>(GetOwner()) : Character;
	...
	for (auto& BoxPair : Character->HitCollisionBoxes)
	{
		...
		{
			UE_LOG(LogTemp, Error, TEXT("HitBox %s is nullptr"), *BoxPair.Key.ToString());
			continue;
		}
