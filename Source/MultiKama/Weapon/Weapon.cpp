...
{
	OwnerCharacter = OwnerCharacter == nullptr ? Cast<AMyCharacter>(GetOwner()) : OwnerCharacter;
	if (OwnerCharacter)
	{
...
void AWeapon::OnRep_Owner()
{
	...
	{
		OwnerCharacter = OwnerCharacter == nullptr ? Cast<AMyCharacter>(Owner) : OwnerCharacter;
